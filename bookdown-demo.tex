...
\toprule
\endhead
Sample\_1 & 0.57 & 0.79 & 0.67 & 0.61 & 0.61 & 0.78 & 0.76 & 0.55 & 0.78 & 0.74 \\
Sample\_2 & 0.64 & 0.74 & 0.74 & 0.70 & 0.51 & 0.80 & 0.59 & 0.51 & 0.73 & 0.70 \\
Sample\_3 & 0.58 & 0.68 & 0.85 & 0.69 & 0.62 & 0.71 & 0.80 & 0.66 & 0.75 & 0.54 \\
Sample\_4 & 0.71 & 0.69 & 0.87 & 0.61 & 0.76 & 0.67 & 0.67 & 0.71 & 0.64 & 0.90 \\
Sample\_5 & 0.80 & 0.71 & 0.58 & 0.77 & 0.80 & 0.39 & 0.89 & 0.59 & 0.70 & 0.62 \\
Sample\_6 & 0.79 & 0.72 & 0.67 & 0.78 & 0.74 & 0.74 & 0.81 & 0.80 & 0.63 & 0.84 \\
Sample\_7 & 0.58 & 0.69 & 0.67 & 0.79 & 0.71 & 0.69 & 0.76 & 0.64 & 0.70 & 0.69 \\
Sample\_8 & 0.59 & 0.52 & 0.62 & 0.65 & 0.67 & 0.83 & 0.56 & 0.66 & 0.71 & 0.73 \\
Sample\_9 & 0.89 & 0.63 & 0.58 & 0.55 & 0.85 & 0.80 & 0.87 & 0.73 & 0.48 & 0.61 \\
Sample\_10 & 0.80 & 0.65 & 0.48 & 0.75 & 0.57 & 0.64 & 0.66 & 0.52 & 0.83 & 0.67 \\
Sample\_11 & 0.73 & 0.64 & 0.90 & 0.49 & 0.80 & 0.63 & 0.62 & 0.63 & 0.69 & 0.85 \\
Sample\_12 & 0.92 & 0.65 & 0.62 & 0.60 & 0.74 & 0.71 & 0.72 & 0.66 & 0.78 & 0.58 \\
Sample\_13 & 0.85 & 0.63 & 0.68 & 0.65 & 0.76 & 0.72 & 0.74 & 0.61 & 0.71 & 0.75 \\
Sample\_14 & 0.65 & 0.77 & 0.54 & 0.65 & 0.54 & 0.84 & 0.51 & 0.70 & 0.62 & 1.04 \\
Sample\_15 & 0.92 & 0.83 & 0.92 & 0.61 & 0.85 & 0.72 & 0.56 & 0.55 & 0.64 & 0.78 \\
Sample\_16 & 0.71 & 0.49 & 0.82 & 0.68 & 0.82 & 0.56 & 0.86 & 0.66 & 0.47 & 0.64 \\
Sample\_17 & 0.68 & 0.89 & 0.75 & 0.70 & 0.62 & 0.78 & 0.75 & 0.72 & 0.58 & 0.80 \\
Sample\_18 & 0.67 & 0.59 & 0.73 & 0.60 & 0.70 & 0.70 & 0.83 & 0.80 & 0.71 & 0.82 \\
Sample\_19 & 0.69 & 0.76 & 0.88 & 0.68 & 0.78 & 0.73 & 0.71 & 0.71 & 0.72 & 0.66 \\
Sample\_20 & 0.80 & 0.92 & 0.56 & 0.40 & 0.72 & 0.64 & 0.61 & 0.67 & 0.57 & 0.60 \\
\bottomrule
\end{longtable}
...
## [1,] 0.686 0.666 0.688 0.723 0.685 0.752 0.692 0.654 0.699 0.657
## [2,] 0.698 0.698 0.710 0.686 0.738 0.671 0.727 0.715 0.732 0.649
\end{verbatim}

The standard deviation of the 20 sample means reported above is 0.0289084.
Now suppose that we only had Sample 1 (i.e., the top row of data).
The standard deviation of Sample 1 is \(s =\) 0.0946573.
We can calculate the standard error from these sample values below,

\[s = \frac{0.0946573}{\sqrt{10}} = 0.0299333.\]

The estimate of the standard error from calculating the standard deviation of the sample means is therefore 0.0289084, and the estimate from just using the standard error formula and data from only Sample 1 is 0.0299333.
...
If we wanted to do the same exercise here, we might find the probability of sampling a DBH \textgreater{} 30 using the Compute probability function (the answer is P = 0.278).
...
We would need to use the standard deviation \emph{of sample mean} \(\bar{x}\) around the true mean \(\mu\), rather than the sample standard deviation.
...
Instead, we can get a more accurate of CIs using a t-distribution.
Jamovi does usually this automatically when calculating CIs outside of the distrACTION module.
...
You might have been expecting a bit more of a difference, but remember, for sufficiently large sample sizes (around N = 30), the normal and t-distributions a very similar (see \protect\hyperlink{Chapter_18}{Chapter 18}).
...
In Exercises 19.1 and 19.2, the sample size of DBH was fairly large (N = 122).
...
What assumptions did we need to make when constructing confidence intervals for the proportion of sites that are grazing?
...
Reflect again on what these vales actually mean.
...
\begin{quote}
\textbf{A p-value is the probability of getting a result as or more extreme than the one observed assuming \(H_{0}\) is true.}
\end{quote}
...
How does this work?
Recall from \protect\hyperlink{Chapter_15}{Chapter 15} that, due to the central limit theorem, the distribution of sample means (\(\bar{x}\)) will be normally distributed around the true mean \(\mu\) as sample size N increases.
...
\begin{figure}
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-90-1} \caption{A t-distribution. Grey shade 95 CI}\label{fig:unnamed-chunk-90}
\end{figure}
...
\hypertarget{non-parametric-alternative}{%
\section{Non-parametric alternative}\label{non-parametric-alternative}}
