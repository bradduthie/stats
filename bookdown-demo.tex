...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-35-1} \caption{Example histogram fig fruit width (cm) using data from 78 fig fruits collected in in 2010 from Baja, Mexico.}\label{fig:unnamed-chunk-35}
\end{figure}
...
For example, in the \href{https://raw.githubusercontent.com/bradduthie/SCIU4T4/main/data/fig_fruits.csv}{fig fruits} data set from \protect\hyperlink{Chapter_8}{Chapter 8} (right click and ``Save Link As\ldots{}''), 78 fig fruits were collected from 4 different trees (A, B, C, and D).
...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-41-1} \caption{Example histogram fig fruit width (cm) using data from 78 fig fruits collected in in 2010 from Baja, Mexico. The mean of the distribution is indicated with an arrow.}\label{fig:unnamed-chunk-41}
\end{figure}
...
\toprule
\endhead
Sample\_1 & 0.64 & 0.79 & 0.53 & 0.68 & 0.78 & 0.76 & 0.74 & 0.66 & 0.70 & 0.81 \\
Sample\_2 & 0.80 & 0.77 & 0.68 & 0.79 & 0.67 & 0.81 & 0.63 & 0.66 & 0.83 & 0.59 \\
Sample\_3 & 0.70 & 0.77 & 0.75 & 0.63 & 0.61 & 0.77 & 0.79 & 0.83 & 0.78 & 0.77 \\
Sample\_4 & 0.80 & 0.62 & 0.81 & 0.68 & 0.59 & 0.84 & 0.83 & 0.71 & 0.50 & 0.69 \\
Sample\_5 & 0.97 & 0.71 & 0.57 & 0.71 & 0.66 & 0.60 & 0.81 & 0.61 & 0.62 & 0.75 \\
Sample\_6 & 0.84 & 0.83 & 0.67 & 0.76 & 0.80 & 0.62 & 0.56 & 0.68 & 0.40 & 0.79 \\
Sample\_7 & 0.78 & 0.79 & 0.78 & 0.88 & 0.79 & 0.72 & 0.75 & 0.51 & 0.81 & 0.62 \\
Sample\_8 & 0.77 & 0.68 & 0.60 & 0.64 & 0.63 & 0.92 & 0.93 & 0.75 & 0.69 & 0.88 \\
Sample\_9 & 0.71 & 0.78 & 0.58 & 0.62 & 0.80 & 0.58 & 0.85 & 0.72 & 0.59 & 0.77 \\
Sample\_10 & 0.68 & 0.68 & 0.60 & 0.63 & 0.92 & 0.90 & 0.65 & 0.85 & 0.77 & 0.60 \\
Sample\_11 & 0.76 & 0.75 & 0.73 & 0.70 & 0.68 & 0.54 & 0.75 & 0.64 & 0.78 & 0.68 \\
Sample\_12 & 0.72 & 0.84 & 0.73 & 0.75 & 0.63 & 0.73 & 0.77 & 0.76 & 0.76 & 0.60 \\
Sample\_13 & 0.70 & 0.68 & 0.83 & 0.77 & 0.66 & 0.73 & 0.79 & 0.65 & 0.70 & 0.79 \\
Sample\_14 & 0.75 & 0.71 & 0.81 & 0.68 & 0.74 & 0.82 & 0.86 & 0.73 & 0.73 & 0.61 \\
Sample\_15 & 0.77 & 0.71 & 0.78 & 0.79 & 0.69 & 0.78 & 0.81 & 0.67 & 0.71 & 0.73 \\
Sample\_16 & 0.72 & 0.89 & 0.80 & 0.63 & 0.68 & 0.70 & 0.58 & 0.64 & 0.80 & 0.75 \\
Sample\_17 & 0.44 & 0.80 & 0.76 & 0.57 & 0.79 & 0.74 & 0.80 & 0.51 & 0.79 & 0.57 \\
Sample\_18 & 0.79 & 0.78 & 0.51 & 0.68 & 0.59 & 0.56 & 0.81 & 0.68 & 0.67 & 0.61 \\
Sample\_19 & 0.62 & 0.69 & 0.59 & 0.81 & 0.65 & 0.72 & 0.70 & 0.63 & 0.78 & 0.76 \\
Sample\_20 & 0.60 & 0.48 & 0.68 & 0.65 & 0.82 & 0.64 & 0.68 & 0.63 & 0.74 & 0.65 \\
\bottomrule
\end{longtable}
...
## [1,] 0.709 0.723 0.74 0.707 0.701 0.695 0.743 0.749 0.700 0.728
## [2,] 0.701 0.729 0.73 0.744 0.744 0.719 0.677 0.668 0.695 0.657
\end{verbatim}

The standard deviation of the 20 sample means reported above is 0.026524.
Now suppose that we only had Sample 1 (i.e., the top row of data).
The standard deviation of Sample 1 is \(s =\) 0.0853034.
We can calculate the standard error from these sample values below,

\[s = \frac{0.0853034}{\sqrt{10}} = 0.0269753.\]

The estimate of the standard error from calculating the standard deviation of the sample means is therefore 0.026524, and the estimate from just using the standard error formula and data from only Sample 1 is 0.0269753.
...
In Jamovi, calculate the grand mean and standard deviation of trees (i.e., the mean and standard deviatio of trees across all sites).
