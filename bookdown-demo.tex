...
\toprule
\endhead
Sample\_1 & 0.65 & 0.54 & 0.65 & 0.65 & 0.89 & 0.59 & 0.69 & 0.79 & 0.66 & 0.62 \\
Sample\_2 & 0.80 & 1.07 & 0.69 & 0.60 & 0.73 & 0.58 & 0.83 & 0.84 & 0.67 & 0.64 \\
Sample\_3 & 0.67 & 0.80 & 0.83 & 0.70 & 0.64 & 0.65 & 0.70 & 0.68 & 0.65 & 0.74 \\
Sample\_4 & 0.76 & 0.74 & 0.65 & 0.58 & 0.72 & 0.62 & 0.56 & 0.74 & 0.68 & 0.67 \\
Sample\_5 & 0.69 & 0.73 & 0.87 & 0.77 & 0.66 & 0.62 & 0.64 & 0.57 & 0.84 & 0.63 \\
Sample\_6 & 0.70 & 0.67 & 0.68 & 0.60 & 0.60 & 0.87 & 0.79 & 0.54 & 0.62 & 0.71 \\
Sample\_7 & 0.66 & 0.80 & 0.53 & 0.88 & 0.62 & 0.57 & 0.65 & 0.73 & 0.62 & 0.58 \\
Sample\_8 & 0.67 & 0.77 & 0.77 & 0.63 & 0.66 & 0.85 & 0.56 & 0.72 & 0.74 & 0.89 \\
Sample\_9 & 0.68 & 0.63 & 0.66 & 0.65 & 0.61 & 0.70 & 0.82 & 0.80 & 0.84 & 0.77 \\
Sample\_10 & 0.72 & 0.85 & 0.65 & 0.83 & 0.93 & 0.86 & 0.85 & 0.52 & 0.61 & 0.67 \\
Sample\_11 & 0.85 & 0.74 & 0.74 & 0.60 & 0.70 & 0.54 & 0.61 & 0.65 & 0.78 & 0.47 \\
Sample\_12 & 0.78 & 0.60 & 0.73 & 0.65 & 0.62 & 0.88 & 0.55 & 0.59 & 0.68 & 0.89 \\
Sample\_13 & 0.86 & 0.74 & 0.87 & 0.73 & 0.66 & 0.50 & 0.76 & 0.78 & 0.74 & 0.76 \\
Sample\_14 & 0.48 & 0.55 & 0.74 & 0.71 & 0.83 & 0.73 & 0.95 & 0.70 & 0.63 & 0.70 \\
Sample\_15 & 0.72 & 0.69 & 0.74 & 0.80 & 0.69 & 0.69 & 0.84 & 0.66 & 0.61 & 0.63 \\
Sample\_16 & 0.67 & 0.90 & 0.66 & 0.74 & 0.87 & 0.63 & 0.63 & 0.49 & 0.95 & 0.59 \\
Sample\_17 & 0.82 & 0.70 & 0.58 & 0.63 & 0.47 & 0.58 & 0.73 & 0.64 & 0.67 & 0.62 \\
Sample\_18 & 0.77 & 0.64 & 0.85 & 0.78 & 0.51 & 0.69 & 0.60 & 0.60 & 0.59 & 0.67 \\
Sample\_19 & 0.79 & 0.65 & 0.75 & 0.71 & 0.76 & 0.72 & 0.75 & 0.81 & 0.57 & 0.85 \\
Sample\_20 & 0.69 & 0.78 & 0.74 & 0.65 & 0.85 & 0.61 & 0.90 & 0.83 & 0.78 & 0.80 \\
\bottomrule
\end{longtable}
...
## [1,] 0.673 0.745 0.706 0.672 0.702 0.678 0.664 0.726 0.716 0.749
## [2,] 0.668 0.697 0.740 0.702 0.707 0.713 0.644 0.670 0.736 0.763
\end{verbatim}

The standard deviation of the sample means reported above is 0.0329233.
Now suppose that we only had Sample 1 (i.e., the top row of data).
The standard deviation of Sample 1 is \(s =\) 0.1001166.
We can calculate the standard error from these sample values below,

\[s = \frac{0.1001166}{\sqrt{10}} = 0.0316596.\]

The estimate of the standard error from calculating the standard deviation of the sample means is therefore 0.0329233, and the estimate from just using the standard error formula and data from only Sample 1 is 0.0316596.
...
\hypertarget{the-normal-distribution-and-probability}{%
\section{The normal distribution and probability}\label{the-normal-distribution-and-probability}}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/power_up} \caption{Welcome screen of the mobile game Power Up!}\label{fig:unnamed-chunk-61}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_power_up_frequencies} \caption{Jamovi Descriptives toolbar showing the OS column from the Power Up! dataset selected. The 'Frequency tables' checkbox builds a table of counts and percentages.}\label{fig:unnamed-chunk-62}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-64-1} \caption{Distribution of player scores in the game Power Up!}\label{fig:unnamed-chunk-64}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-65-1} \caption{Distribution of player scores in the game Power Up! shown in histogram bars. The overlaid curve shows the probability density function for a normal distribution that has the same mean and standard deviation as the sample described by the histogram.}\label{fig:unnamed-chunk-65}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_toolbar_modules} \caption{Jamovi tool bar, which includes an option for downloading new Modules (right hand side)}\label{fig:unnamed-chunk-66}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_toolbar_modules_distrACTION} \caption{Jamovi tool bar, which includes an added module called distrACTION.}\label{fig:unnamed-chunk-67}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_normal_distribution} \caption{Jamovi options for the distrACTION module for computing probability for a given normal distribution. The example shown here calculates the probability that a value sampled from the normal distribution of interest is less than 80.}\label{fig:unnamed-chunk-68}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_RjEditor} \caption{Jamovi interface for the Rj Editor module. Code can be run by clicking on the green triangle in the upper left.}\label{fig:unnamed-chunk-70}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_clt} \caption{Jamovi interface for the 'Demonstrations' module, which allows users to randomly generate data from a specific source distribution (normal, uniform, geometric, lognormal, and binary), sample size, and number of trials (i.e., variables)}\label{fig:unnamed-chunk-73}
\end{figure}
