...
\toprule
\endhead
Sample\_1 & 0.73 & 0.61 & 0.65 & 0.73 & 0.50 & 0.75 & 0.72 & 0.76 & 0.78 & 0.63 \\
Sample\_2 & 0.93 & 0.48 & 0.82 & 0.74 & 0.76 & 0.64 & 0.72 & 0.81 & 0.51 & 0.66 \\
Sample\_3 & 0.57 & 0.93 & 0.62 & 0.89 & 0.50 & 0.67 & 0.74 & 0.70 & 0.70 & 0.88 \\
Sample\_4 & 0.74 & 0.63 & 0.81 & 0.49 & 0.54 & 0.88 & 0.70 & 0.76 & 0.62 & 0.96 \\
Sample\_5 & 0.75 & 0.91 & 0.73 & 0.78 & 0.69 & 0.71 & 0.72 & 0.83 & 0.63 & 0.78 \\
Sample\_6 & 0.48 & 0.71 & 0.84 & 0.58 & 0.55 & 0.77 & 0.80 & 0.70 & 0.72 & 0.72 \\
Sample\_7 & 0.61 & 0.86 & 0.67 & 0.64 & 0.71 & 0.74 & 0.70 & 0.63 & 0.66 & 0.87 \\
Sample\_8 & 0.74 & 0.48 & 0.67 & 0.77 & 0.57 & 0.66 & 0.84 & 0.65 & 0.74 & 0.64 \\
Sample\_9 & 0.75 & 0.61 & 0.81 & 0.81 & 0.75 & 0.76 & 0.79 & 0.70 & 0.76 & 0.85 \\
Sample\_10 & 0.63 & 0.63 & 0.77 & 0.71 & 0.57 & 0.66 & 0.78 & 0.81 & 0.62 & 0.62 \\
Sample\_11 & 0.64 & 0.66 & 0.80 & 0.47 & 0.80 & 0.60 & 0.62 & 0.94 & 0.68 & 0.59 \\
Sample\_12 & 0.71 & 0.73 & 0.66 & 0.77 & 0.75 & 0.67 & 0.78 & 0.75 & 0.59 & 0.73 \\
Sample\_13 & 0.76 & 0.66 & 0.76 & 0.61 & 0.79 & 0.65 & 0.61 & 0.72 & 0.73 & 0.54 \\
Sample\_14 & 0.77 & 0.76 & 0.78 & 0.83 & 0.68 & 0.76 & 0.57 & 0.63 & 0.77 & 0.68 \\
Sample\_15 & 0.88 & 0.80 & 0.69 & 0.50 & 0.43 & 0.78 & 0.65 & 0.63 & 0.79 & 0.65 \\
Sample\_16 & 0.83 & 0.76 & 0.54 & 0.62 & 0.73 & 0.61 & 0.77 & 0.78 & 0.76 & 0.78 \\
Sample\_17 & 0.84 & 0.72 & 0.71 & 0.73 & 0.88 & 0.68 & 0.61 & 0.67 & 0.79 & 0.81 \\
Sample\_18 & 0.54 & 0.70 & 0.84 & 0.76 & 0.70 & 0.75 & 0.69 & 0.74 & 0.74 & 0.61 \\
Sample\_19 & 0.69 & 0.53 & 0.73 & 0.64 & 0.80 & 0.62 & 0.53 & 0.86 & 0.73 & 0.76 \\
Sample\_20 & 0.59 & 0.73 & 0.59 & 0.59 & 0.67 & 0.61 & 0.62 & 0.69 & 0.63 & 0.75 \\
\bottomrule
\end{longtable}
...
## [1,] 0.686 0.707 0.720 0.713 0.753 0.687 0.709 0.676 0.759 0.680
## [2,] 0.680 0.714 0.683 0.723 0.680 0.718 0.744 0.707 0.689 0.647
\end{verbatim}

The standard deviation of the sample means reported above is 0.0281927.
Now suppose that we only had Sample 1 (i.e., the top row of data).
The standard deviation of Sample 1 is \(s =\) 0.087076.
We can calculate the standard error from these sample values below,

\[s = \frac{0.087076}{\sqrt{10}} = 0.0275358.\]

The estimate of the standard error from calculating the standard deviation of the sample means is therefore 0.0281927, and the estimate from just using the standard error formula and data from only Sample 1 is 0.0275358.
...
The distribution is skewed, with a high probability of 0 success and a diminishing probability of 1 or more success.\footnote{Testing an equation \[y = mx + b.\] Does this get produced inline or not?}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/power_up} \caption{Welcome screen of the mobile game Power Up!}\label{fig:unnamed-chunk-55}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_power_up_frequencies} \caption{Jamovi Descriptives toolbar showing the OS column from the Power Up! dataset selected. The 'Frequency tables' checkbox builds a table of counts and percentages.}\label{fig:unnamed-chunk-56}
\end{figure}
...
\(Pr_{(small\:or\:large)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\(Pr_{(small,\:medium,\:large)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\(Pr_{(Player\:20)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\(Pr_{(Player\:20,\:Large)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\(P_{(Large | Android)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

Is \(P_{(Large | Android)}\) much different from the probability that \emph{any} player chooses a large dam, as calculated in Table 16.1? Do you think that the difference is significant?
...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-58-1} \caption{Distribution of player scores in the game Power Up!}\label{fig:unnamed-chunk-58}
\end{figure}
...
\(P_{(Score>120)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

\(P_{(Score<100)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

\(P_{(100<Score<120)} =\) : \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_
...
\begin{figure}
\includegraphics[width=1\linewidth]{bookdown-demo_files/figure-latex/unnamed-chunk-59-1} \caption{Distribution of player scores in the game Power Up! shown in histogram bars. The overlaid curve shows the probability density function for a normal distribution that has the same mean and standard deviation as the sample described by the histogram.}\label{fig:unnamed-chunk-59}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_toolbar_modules} \caption{Jamovi tool bar, which includes an option for downloading new Modules (right hand side)}\label{fig:unnamed-chunk-60}
\end{figure}
...
\begin{figure}
\includegraphics[width=1\linewidth]{img/jamovi_toolbar_modules_distrACTION} \caption{Jamovi tool bar, which includes an added module called distrACTION.}\label{fig:unnamed-chunk-61}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_normal_distribution} \caption{Jamovi options for the distrACTION module for computing probability for a given normal distribution. The example shown here calculates the probability that a value sampled from the normal distribution of interest is less than 80.}\label{fig:unnamed-chunk-62}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_RjEditor} \caption{Jamovi interface for the Rj Editor module. Code can be run by clicking on the green triangle in the upper left.}\label{fig:unnamed-chunk-64}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{img/jamovi_clt} \caption{Jamovi interface for the 'Demonstrations' module, which allows users to randomly generate data from a specific source distribution (normal, uniform, geometric, lognormal, and binary), sample size, and number of trials (i.e., variables)}\label{fig:unnamed-chunk-67}
\end{figure}
